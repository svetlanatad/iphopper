...
begin
  ...
  try
    ...
    TCPClient.Port := 9051;  // Tor control port
    TCPClient.Connect;
    try
      // Authenticate with the control port; replace 'yourpassword' with your control password
      TCPClient.IOHandler.WriteLn('AUTHENTICATE "REPLACE WITH YOUR PASSWORD"');
      // Send the signal to get a new identity
...
begin
  ...
  begin
    ...
    begin
      Width := 200;  // Set the width of the panel
